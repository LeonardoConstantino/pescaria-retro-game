...
export const IDLE_UPGRADES: IdleUpgrade[] = [
  ...
  // ── 4. CANOA COM REDE (canoe_net) ──
  {
    ...
    targetTierId: 'canoe_net',
    effectType: 'tier_multiplier',
    multiplier: 2,
    requirement: { tierId: 'canoe_net', minCount: 1 },
  },
  {
    id: 'upg_canoe_2',
    ...
    effectType: 'tier_multiplier',
    multiplier: 2,
    requirement: { tierId: 'canoe_net', minCount: 5 },
  },

  // ── 5. BRIGADA DE ARIRANHAS (otter_brigade) ──
  {
    id: 'upg_otter_1',
    ...
    targetTierId: 'otter_brigade',
    effectType: 'tier_multiplier',
    multiplier: 2,
    requirement: { tierId: 'otter_brigade', minCount: 1 },
  },
  {
    id: 'upg_otter_2',
    ...
    effectType: 'tier_multiplier',
    multiplier: 2,
    requirement: { tierId: 'otter_brigade', minCount: 5 },
  },

  // ── 6. TRAINEIRA A VAPOR (trawler_ship) ──
  {
    id: 'upg_trawler_1',
    ...
    targetTierId: 'trawler_ship',
    effectType: 'tier_multiplier',
    multiplier: 2,
    requirement: { tierId: 'trawler_ship', minCount: 1 },
  },
